...
export const statusUpdateSchema = z.object({ fulfillmentStatus: z.enum(["WAITING_PAYMENT", "PAID", "WAITING_PRODUCTION", "IN_PRODUCTION", "RECEIVED_FROM_SUPPLIER", "READY_FOR_PICKUP", "PICKED_UP", "CANCELLED"]), note: z.string().trim().max(500).optional() });
